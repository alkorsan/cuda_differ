...
class MyersSequenceMatcher(difflib.SequenceMatcher):
    ...
    def __init__(self, isjunk=None, a="", b=""):
        ...
        # Initialize the inherited difflib.SequenceMatcher state so that the
        # inherited set_seq1/set_seq2/real_quick_ratio/quick_ratio/ratio
        # methods (used when this matcher is reused for character-level
        ...
        # implement the autojunk heuristic and must not silently apply it
        # in the inherited chain_b/quick_ratio code paths. The a/b passed
        # here are empty strings (not the caller's sequences) because we
        # re-set self.a/self.b explicitly below; this avoids slicing
        # overhead and matches the original semantics where Myers owns
