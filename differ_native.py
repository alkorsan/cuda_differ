...
class Differ:
    ...
    def compare(self, a_text, b_text, opcodes=None):
        ...
        # (compare:algorithm, per-chunk compare:event_generation).
        ...
        # ('compare:event_generation' opens AFTER the chunk list is built
        # and closed BEFORE it is yielded); equal/delete/insert/ignore
